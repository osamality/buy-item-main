      ...
      <ScrollView
        ...
        <View
          ...
          <View style={{width: '100%', marginTop: '10%'}}>
            {form2.map((item, key) => (
              <View style={{marginBottom: 10,flexDirection:'row',borderBottomWidth:1,borderBottomColor:"lightgray",paddingVertical:10}} key={key}>
                <Label style={{color: 'black', fontSize: 16, marginBottom: 10,width:"40%"}}>
                  {item.label}
                </Label>
